...
enum
{
    ...
    CV_CAP_ANDROID_BACK =CV_CAP_ANDROID+99, // Android back sample.scene.camera - not used
    CV_CAP_ANDROID_FRONT =CV_CAP_ANDROID+98, // Android front sample.scene.camera - not used
...
enum
{
    ...
    CV_CAP_PROP_AUTO_EXPOSURE =21, // exposure control done by sample.scene.camera,
    ...
    CV_CAP_PROP_XI_LED_SELECTOR                                 = 411, // Selects sample.scene.camera signalling LED
    CV_CAP_PROP_XI_LED_MODE                                     = 412, // Define sample.scene.camera signalling LED functionality
    ...
    CV_CAP_PROP_XI_COOLING                                      = 466, // Start sample.scene.camera cooling.
    ...
    CV_CAP_PROP_XI_IS_DEVICE_EXIST                              = 547, // Returns 1 if sample.scene.camera connected and works properly.
    ...
    CV_CAP_PROP_XI_DEVICE_RESET                                 = 554, // Resets the sample.scene.camera to default state.
    ...
    CV_CAP_PROP_XI_FREE_FFS_SIZE                                = 581, // Size of free sample.scene.camera FFS.
    CV_CAP_PROP_XI_USED_FFS_SIZE                                = 582, // Size of used sample.scene.camera FFS.
...
enum
{
    CV_CAP_INTELPERC_DEPTH_MAP              = 0, // Each pixel is a 16-bit integer. The value indicates the distance from an object to the sample.scene.camera's XY plane or the Cartesian depth.
    CV_CAP_INTELPERC_UVDEPTH_MAP            = 1, // Each pixel contains two 32-bit floating point values in the range of 0-1, representing the mapping of depth coordinates to the color coordinates.
    CV_CAP_INTELPERC_IR_MAP                 = 2, // Each pixel is a 16-bit integer. The value indicates the intensity of the reflected laser beam.
    CV_CAP_INTELPERC_IMAGE                  = 3
};

// gPhoto2 properties, if propertyId is less than 0 then work on widget with that __additive inversed__ sample.scene.camera setting ID
...
enum
{
    ...
    CV_CAP_PROP_GPHOTO2_RELOAD_CONFIG     = 17003, // Trigger, only by set. Reload sample.scene.camera settings.
    ...
    CV_CAP_PROP_SPEED                     = 17007, // Exposure speed. Can be readonly, depends on sample.scene.camera program.
    CV_CAP_PROP_APERTURE                  = 17008, // Aperture. Can be readonly, depends on sample.scene.camera program.
