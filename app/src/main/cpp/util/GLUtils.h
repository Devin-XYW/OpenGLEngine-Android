...
public:
    ...
    static GLuint LoadShader(AAssetManager *mAssetManager, const char *sPath, int sType);
    ...
    static GLuint CreateProgram(AAssetManager *mAssetManager,const char *vertexShaderPath, const char *fragShaderPath);
