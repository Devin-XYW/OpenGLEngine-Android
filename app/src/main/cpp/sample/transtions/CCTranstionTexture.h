...
#ifndef OPENGLENGINE_CCTRANSTIONTEXTURE_H
#define OPENGLENGINE_CCTRANSTIONTEXTURE_H

#include "GLBaseSample.h"
class CCTranstionTexture : public GLBaseSample{
public:
    CCTranstionTexture();
    ~CCTranstionTexture();
...
#endif //OPENGLENGINE_CCTRANSTIONTEXTURE_H
